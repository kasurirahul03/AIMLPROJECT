...
min_width_rect = 80  # Changed to rect to match rectangle
min_height_rect = 80
...
while True:
    ...
    for (i, c) in enumerate(contours):  # Corrected variable name here
    ...
    if cv2.waitKey(1) == 13:  # Ensure correct case for waitKey
        break
